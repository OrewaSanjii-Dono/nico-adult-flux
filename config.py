...
FORCE_SUB_CHANNEL_1 = int(os.environ.get("FORCE_SUB_CHANNEL_1", "-1002381818578"))
FORCE_SUB_CHANNEL_2 = int(os.environ.get("FORCE_SUB_CHANNEL_2", "-1002409372155"))
FORCE_SUB_CHANNEL_3 = int(os.environ.get("FORCE_SUB_CHANNEL_3", "-1002443808751"))
FORCE_SUB_CHANNEL_4 = int(os.environ.get("FORCE_SUB_CHANNEL_4", "-1002338697399"))
...
try:
    ADMINS=[7263364323]
    for x in (os.environ.get("ADMINS", "7263364323 1683225887 7162615398 7827448605").split()):
        ADMINS.append(int(x))
except ValueError:
